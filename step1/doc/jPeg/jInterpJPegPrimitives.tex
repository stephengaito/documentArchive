...
void jPegFailWord(ContextObj *aCtx) {
  ...
  DEBUG(DebugMask, "jPegFailWord%s\n", "");
  ...
  while(aCtx->process) {
    ...
    if (
      ...
      DEBUG(DebugMask, "jPegFailWord found (%s)[%s]\n",
...
void registerJPegWords(ContextObj *aCtx) {
  ...
  registerCFunction(symTab, "parseRepeatCont",        jPegRepeatContinueWord);
  registerCFunction(symTab, "parseRepeat",            jPegRepeatWord);
  registerCFunction(symTab, "parseRepeatContAtLeast", jPegRepeatAtLeastContinueWord);
  registerCFunction(symTab, "parseRepeatAtLeast",     jPegRepeatAtLeastWord);
  registerCFunction(symTab, "parseRepeatContAtMost",  jPegRepeatAtMostContinueWord);
