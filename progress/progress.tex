...
five distinct documents. The first one, this document, will highlight the 
...
Two-shift maps, written in \LaTeX\ as a long article and a book respectively. 
Finally, the fourth and fifth documents, will be same mathematical exposition 
redone using \ConTeXt, again in both a long article and a book format. 
