...
@title[#:tag "top"]{STLCAlg}
@(author-stg)

@defmodule[STLCAlg]

The @racketmodname[STLCAlg] language provides the code to implement the
STLCAlg interpreter.
...
The primary aim of the STLCAlg interpreter @emph{is @bold{not}} to be 
...
cross-compiled Pure LISP version of any STLCAlg language construct.
