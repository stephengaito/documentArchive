...
@(require STLCAlg/terms
          STLCAlg/types
          "utils.rkt")
@(require (for-label racket STLCAlg/terms STLCAlg/types))

@title[#:tag "terms"]{STLCAlg terms}
@(author-stg)

@defmodule[STLCAlg/terms]

The @racketmodname[STLCAlg/terms] module implements the STLCAlg 
