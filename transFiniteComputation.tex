...
A path, $P_1(V^{P_1}, E^{P_1}, \pi^{P_1}_0, \pi^{P_1}_1)$, \define{extends}{} a path,
...
\pi^{P_1}_0, \pi^{P_1}_1)$, an edge, $e_0 \in E^{P_0}$ \define{covers}{} an edge, $e_1 \in
...
embedding, \map{\phi}{P_0}{P_1} for which for any pair of distinct vertices, $x_1, y_1
