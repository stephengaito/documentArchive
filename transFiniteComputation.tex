...
\begin{definition}
For a path, $P(V, E, \pi_0, \pi_1)$, a \define{maximal}{} (respectively
\define{minimal}{}) element is a vertex, $\top \in V$ ($\bottom \in V$), for which for
every vertex, $x \in V$, there exists an edge $(x,\top) \in E$ ($(\bottom, x) \in E$).

A \define{$1$-interval}{} is a $1$-path which has both maximal and minimal elements. Given 
