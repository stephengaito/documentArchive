...
the asertion failure reasons as the second item on the stack. The 
...
(
  ...
  (
    ...
    ;; then comes the number of attempts value
    ;; then comes the number of failures value
    ;; then comes the collection of failure reports
    append
    extract
