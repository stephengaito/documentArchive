...
First we create a context which will run of the test case provide. The 
list of test words is located on the top of the joylol-main context and 
are used by the newContext word as the initial process stack for the 
testRunner context. 
