...
\CHeaderIncludeGuard{public}{JOYLOL_COALG_JOYLOL_TESTS}
\createCHeaderFile%
  {public}
...
\startCHeader
extern size_t joylol_register_joylolTests(JoyLoLInterp *jInterp);
\stopCHeader
\setCHeaderStream{public}

\CHeaderIncludeGuard{private}{JOYLOL_COALG_JOYLOL_TESTS_PRIVATE}
\createCHeaderFile%
  {private}
...
#include <joylol/joylolTests.h>
#include <joylol/joylolTests-private.h>
// dictionary
// printer
\stopCCode
...
\addCTestInclude{<joylol/joylolTests.h>}
\addCTestInclude{<joylol/joylolTests-private.h>}
...
\addJoylolTestInclude{joylol/joylolTests-tests}
\createJoylolTestFile%
  {default}%
  {allJoylolTests.joy}%
  {}

\addMainDocument{joylolTests.tex}
