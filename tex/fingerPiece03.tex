...
2 (page 884) of Cantor's Grundlangen. NEED to find section where Cantor
describes what will become known variously as Burali-Forti or Cantor's paradox.
Note that in this section Cantor clearly considers the proper-infinite as
well-founded, where as the improper infinite is (by implication)
non-well-founded.}
