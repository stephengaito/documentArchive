...
\startsubsection[title=Bootstrapping JoyLoL]

Since we want as rigorous as possible toolset, we ultimately need to use 
...
toolset by building an initial version of JoyLoL which is not rigorously 
checked. 
