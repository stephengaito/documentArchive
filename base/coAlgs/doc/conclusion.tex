...
static size_t joylol_register_coAlgs(lua_State *lstate) {
  ...
  theCoAlg->name         = "CoAlgs";
  theCoAlg->registerFunc = joylol_register_coAlgs;
...
\addSubDocument{joyLoLInterp.tex} 
