...
process. The following \type{requireStaticallyLinkedParsers} does just 
this. 

\startCHeader
Boolean requireStaticallyLinkedParsers(
  lua_State *lstate
);
\stopCHeader
...
Boolean requireStaticallyLinkedParsers(
  ...
  luaopen_joylol_parsers(lstate);
  lua_setfield(lstate, -2, "joylol.parsers");
