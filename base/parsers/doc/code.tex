...
\startCHeader
typedef CoAlgObj *(ParseOneSymbol)(
  TextObj *aText
);
...
\setCHeaderStream{private}
\startCHeader
extern CoAlgObj* parseOneSymbolImpl(
  TextObj* aText
);
\stopCHeader
\setCHeaderStream{public}
...
\startCHeader
typedef CoAlgObj *(ParseAllSymbols)(
  TextObj *aText
);
...
\setCHeaderStream{private}
\startCHeader
extern CoAlgObj* parseAllSymbolsImpl(
  TextObj* aText
);
\stopCHeader
\setCHeaderStream{public}
...
\startCTest
  ...
  AssertIntTrue(equalLoLDebug(jInterp, aLoL, lolCopy, FALSE));
\stopCTest
\stopTestCase
...
Boolean registerParsers(
  ...
  theCoAlg->super.registerFunc  = registerParsers;
