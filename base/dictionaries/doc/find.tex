...
\startCHeader
extern DictObj* findSymbolRecurse(JoyLoLInterp* jInterp,
                                  DictObj* anAVLNode,
                                  Symbol* aSymbol);
\stopCHeader
...
\startCCode
DictObj* findSymbolRecurse(JoyLoLInterp* jInterp,
                           DictObj* anAVLNode,
                           Symbol* aSymbol) {
...
\startCHeader
extern DictObj* findSymbol(JoyLoLInterp* jInterp, Symbol* aSymbol);
\stopCHeader

\startCCode
DictObj* findSymbol(JoyLoLInterp* jInterp, Symbol* aSymbol) {
