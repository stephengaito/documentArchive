...
static void lispInterpretAP(ContextObj* aCtx) {
  ...
  CoAlgObj* operationName = asCar(top);
  CoAlgObj* operationBody = asCdr(top);
...
static void lispForAP(ContextObj* aCtx) {
  ...
  if (symbolIs(jInterp, nextCommand, "forDone")) {
    ...
    CoAlgObj* operationName = asCar(nextCommand);
    CoAlgObj* operationBody = asCdr(nextCommand);
...
static void defineAP(ContextObj* aCtx) {
  ...
  defineJoyLoL(aCtx->jInterp, asSymbol(top1), top2);
}
\stopCCode
