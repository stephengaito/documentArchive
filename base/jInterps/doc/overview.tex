...
#define CrossCompilersTag  6
#define DictionariesTag    7
#define FragmentsTag       8
#define LoadersTag         9
#define LuaFunctionsTag   10
#define NaturalsTag       11
#define PairsTag          12
#define ParsersTag        13
#define StringBuffersTag  14
#define SymbolsTag        15
#define TemplatesTag      16
#define TextsTag          17
#define NumRequiredCoAlgs 18
...
#define CrossCompilersName "crossCompilers" /*  6 */
#define DictionariesName   "dictionaries"   /*  7 */
#define FragmentsName      "fragments"      /*  8 */
#define LoadersName        "loaders"        /*  9 */
#define LuaFunctionsName   "luaFunctions"   /* 10 */
#define NaturalsName       "naturals"       /* 11 */
#define PairsName          "pairs"          /* 12 */
#define ParsersName        "parsers"        /* 13 */
#define StringBuffersName  "stringBuffers"  /* 14 */
#define SymbolsName        "symbols"        /* 15 */
#define TemplatesName      "templates"      /* 16 */
#define TextsName          "texts"          /* 17 */
\stopCHeader
