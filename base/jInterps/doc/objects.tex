...
CoAlgObj* newObject(JoyLoLInterp* jInterp, TagType aTag) {
  ...
  if ( ! jInterp->hMem.freeObjects ) collectGarbage(jInterp, aTag);
  if ( ! jInterp->hMem.freeObjects ) addObjectBlock(jInterp, aTag);
...
\startCTest
  ...
  // are initialized...
  CoAlgObj* aNewObject = newObject(jInterp, JInterpsTag);
...
void addObjectBlock(JoyLoLInterp* jInterp, TagType aTag) {
  DEBUG(FALSE, "addObjectBlock > %p %u %zu\n", 
