...
#define asType(aLoL)  (((CoAlgObj*)(aLoL))->type)
#define asTag(aLoL)   (((CoAlgObj*)(aLoL))->tag)
#define asFlags(aLoL) (((CoAlgObj*)(aLoL))->flags)
\stopCHeader
...
void addObjectBlock(JoyLoLInterp* jInterp, TagType aTag) {
  ...
  DEBUG(jInterp, "addObjectBlock > %p %u %zu %zu\n", 
  ...
  DEBUG(jInterp, "addObjectBlock = %p %p\n", 
  ...
  *(void**)nextObject =
  ...
  DEBUG(jInterp, "addObjectBlock < %p %p %p\n",
...
void collectGarbage(JoyLoLInterp* jInterp, TagType aTag) {
  DEBUG(jInterp, "collectGarbage %p\n", jInterp);
  //
...
CoAlgObj* newObjectImpl(
  ...
  assert(jInterp);
  DEBUG(jInterp, "newObjectImpl %p %zu\n", jInterp, (size_t)aTag);
