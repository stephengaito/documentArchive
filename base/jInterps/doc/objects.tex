...
void addObjectBlock(JoyLoLInterp* jInterp, TagType aTag) {
  ...
  for (size_t i = 0 ; i < OBJECT_BLOCK_SIZE ; i++, nextObject += objectSize ) {
    ...
    ((CoAlgObj*)nextObject)->type = (CoAlgebra*)(nextObject + objectSize);
  }
  ((CoAlgObj*)nextObject)->type =
    (CoAlgebra*)(jInterp->coAlgs[aTag].oMem.freeObjects);
