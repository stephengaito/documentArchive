...
typedef Boolean (CoAlgEquality)(CoAlgObj*,
                                CoAlgObj*,
                                Boolean);
typedef CoAlgObj* (CoAlgPrint)(CoAlgObj*);
...
\startCTest
  ...
  AssertPtrEquals(coAlgsVec[coAlgIdx].sClass->coAlgData,    fakeCoAlgData);
\stopCTest
...
\startCTest
  ...
  for(int i = 1; i < 26; i++) {
    *coAlgNameEnd        = 'A' + i;
    ...
    AssertPtrEquals(coAlgsVec[idx].sClass->coAlgData,    fakeCoAlgData);
  }
\stopCTest
