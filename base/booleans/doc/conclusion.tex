...
static size_t joylol_register_booleans(JoyLoLInterp *jInterp) {
  CoAlgebra* theCoAlg    = (CoAlgebra*) calloc(1, sizeof(CoAlgebra));
  theCoAlg->name         = "Booleans";
  theCoAlg->registerFunc = joylol_register_booleans;
  theCoAlg->equalityFunc = NULL;
  theCoAlg->printFunc    = NULL;
  theCoAlg->coAlgData    = NULL;
  registerCoAlgebra(jInterp, theCoAlg);
  assert(theCoAlg->isA == BooleansTag);
...
int luaopen_joylol_booleans (lua_State *lstate) {
  ...
  joylol_register_booleans(jInterp);
