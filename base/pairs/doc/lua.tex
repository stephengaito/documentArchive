...
process. The following \type{requireStaticallyLinkedPairs} does just 
this. 

\startCHeader
Boolean requireStaticallyLinkedPairs(
  lua_State *lstate
);
\stopCHeader
...
Boolean requireStaticallyLinkedPairs(
  ...
  luaopen_joylol_pairs(lstate);
  lua_setfield(lstate, -2, "joylol.pairs");
