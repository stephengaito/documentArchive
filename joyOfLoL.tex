...
can apply the basic joy operations to observe a ``thing's'' ``structure''. Being
...
the process's ongoing behaviour rather than the ``final'' answer if might
compute.
...
they always give the same ``answer''. This is an extensional concept of
equality.
