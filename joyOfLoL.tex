...
of Type Theory provided by \cite[Appendix A.2]{awodey2009a}.

We have three judgements, the first, the positive existence judgement, is
%
\begin{equation*}
x : \sigma : \rho
\end{equation*}
...
The second judgement, the negative existence judgement, is
%
\begin{equation*}
\emptyset : \sigma : \rho
\end{equation*}
%
where, again, $\rho$ is a meta variable denoting a list of lists, and $\sigma$,
is a meta variable denoting a list of lists selector sequence. The judgement
\emph{asserts} that the selected portion of the list of lists is \emph{not} a
valid list of lists.

The third judgement, the null list judgement, is
%
\begin{equation*}
( ) : \sigma : \rho
\end{equation*}
%
where, again, $\rho$ is a meta variable denoting a list of lists, and $\sigma$,
is a meta varialbe denoting a list of lists selector sequence. The judgement
\emph{asserts} that the selected portion of the lists of lists is `$( )$' (the
null list).
