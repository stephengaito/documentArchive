...
we need to carefully distinguish between \MMundi{extra-foundational 
commentary} and the actual re-founded foundations. We will do this by 
placing these \MMundi{extra-foundational comments} in the colour 
...
\startMMundi From the begining of the next section, all extra-foundational 
comments will be carefully deliniated from the re-foundations themselves. 
These exra-foundational comments are most easily expressed using classical 
Category theory. \stopMMundi \TODO{Provide a selection of useful 
references to Category/Topos theory} 

\subsection[title=Semantic Functor]
...
\subsection[title=Syntaxtic Functor]
