...
We begin by building the Semantic Functor, $F$, together with its 
associated $F$-Coalgebra map, $c : \lol \rightarrow F(\lol)$. 
\startMMundi Using the notation from Section 2.2.2 in 
\cite{jacobs2017coalgebras} on \quote{Binary $A$-Trees}, our $F$ functor 
will be essentially $F : \lol \rightarrow \lol \times \lol$.\stopMMundi 
