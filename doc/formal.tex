...
From a high-level, classical, Categorical point of view, the construction 
of the \joylolZero\ interpreter has six \quote{component} 
parts\footnote{See, for example, Definition 6.5.1 
...
\TODO{describe the structure of our Dynamic Logic}

\TODO{describe the fibration we will use}