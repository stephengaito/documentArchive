...
\startsection[title=How rigorous can rigour be?]

We have to start by addressing the \quotation{White Elephant in the Room}, namely: 

\startcenteraligned
\em \bf How much rigour can a finite being, \\
\em \bf or a finite computational device expect to provide?
\stopcenteraligned
