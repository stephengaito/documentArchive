...
Currently, certainty in mathematics, is generally identified with the 
...
mathamatical \quote{proofs} are conducted in an informal but rigorous 
style, the generally acknowledged highest standard of proof is a first, 
second or higher order logical proof using natural deduction. (TODO wrong 
words!) At the moment, the translation of a high-level mathematical 
argument into a \quote{completely rigorous} but impossibly detailed 
logical argument is very tedious and difficult, largely because the highly 
detailed, n-th order logical notation, is very far from the original 
intuitive idea to be proved. 

obtained using a \quote{Formalist} axiomatic 
computation of the \quote{truth} of a logical assertion representing a 

\footnote{While there are 
many discussions of the Logical-Formalist \quote{schools} of the 
foundations of Mathematics \cite[giaquinto2002searchCertainty] provides an 
interesting account of the strengths and weaknesses of these approaches}. 
