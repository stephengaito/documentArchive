...
Over the next three definitions we will explore what a wee beastie can do, 
know, and identify. These three definitions are of necessity, 
...
entity. At any one instant of \quote{time}, this wee beastie (its 
assocaitated computation) will be in a particular \quote{state}. For our 
purposes, these states \emph{will be} \lols. 

\subsection[title=What \emph{can} a \quote{wee beastie} do?]

We begin our definitions by considering what a wee beastie can \emph{do} 
to its environment. 
