...
\TODO{Bayesian brain, markov models, Shalize spacial models required. 
Markov has restrictive scope of description... but by recoding and using 
levels of description, we can recover "non-Axiom-A" behaviour.} 
