...
them focused upon whole problems amidst all of the unending detail. 

\TODO{Vantage point taken influences the questions asked and hence the 
answers found. The choice of where you want to get to.... does have a 
profound influence on how you choose to get there.} 
...
through logic is unable to provide the rigorous foundations we require. 
...
It is equally naive to assert that finite being can not interact with 
...
document using at least one other. So it is reasonable to expect 
\emph{finitist} Mathematics to be founded computationally. 
...
are beyond all human limits to differentiate or understand. This is 
similar to Cantor's expressed understanding of his Absolute Infinite 
Magnitudes, again, see Cantor's letter to Dedekind dated 1899, 
...
\emph{is}. In our future work, this point of view will be indispensable. 
...
systems\footnote{See, for example, 
...
estimated that the human brain consumes around a quarter of all calories 
consumed each day, yet the human brain does not represent a quarter of our 
cells or weight. Nervous systems \emph{are} relatively expensive to 
keep running. For most of a frog's needs, this additional complexity is 
not needed, this is a frog's evolutionary niche.} 
...
which are in turn made up of \quote{quarks}. When I shake your hand, where 
do \quote{my} \quote{quarks} end and \quote{your} \quote{quarks} begin?

A Zen master's view is actually deeply intwined with any model of 
\quote{things} we might build. \TODO{We can not separate one \quote{thing} 
from another \quote{thing} at the \quote{most basic} level.} 
