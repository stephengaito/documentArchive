...
have progressed far enough to be able to define the ordinals, we will 
...
\TODO{We have defined the necessary modal operators, do we need to define 
the corresponding possible modal operators?} 

\startMMundi

The atomic tests provide the \emph{only} \quote{direct} tests that a wee 
beastie can perform. All other tests are formed via various test 
combinators from these three atomic tests. Only the third atomic test 
...
any well-founded \lol\ or finitely defined collection of non-well-founded 
\lols, it is \emph{not} valid for \quote{asymptotically} defined 
