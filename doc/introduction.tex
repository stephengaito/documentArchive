...
\TODO{should we discuss games?}

\TODO{talk about thing-ness/is-ness... Zen versus "us"/"them".. quote 
"What is a thing?", \cite{doeringIsham2008thingTheoryFoundationsPhysics} 
and \cite{heidegger1967whatIsAThing}. If I shake your hand, where do 
\quote{my} \quote{quarks} end and \quote{your} \quote{quarks} begin? We 
collectively, inside each of our game-worlds, take the intentional stance, 
\cite{dennett1987a}. However, given the intentional stance, there is a 
very wide difference in each \quote{thing's} ability to respond to 
\quote{its} environment. This is reflected in the overall complexity in the 
models we build to represent that particular \quote{thing}.} 

\TODO{The choice of where you want to get to.... does have a profound 
influence on how you choose to get there. For this work the focus upon the 
well-founded/data/algebraic versus the 
non-well-founded/process/co-algebraic is all pervasive. } 
