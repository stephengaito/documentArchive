...
\color[darkgray]{grey} angled over and under bars. The top angled bar will 
also contain the word \emph{Classical}. From the beginning of the next 
subsection, all \emph{extra-foundational comments} will be carefully 
