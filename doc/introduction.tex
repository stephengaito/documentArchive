...
\item \TODO{What more needs to be stated?}
...
\placeformula[left]\startformula \startMPcode{commDiag}
  ...
  addArrow(2,1, 1,7, ">", 20)()()("\overline{j}",          0.2, );
  addArrow(2,2, 1,7, ">", 20)()()("T(\overline{j})",       0.2, );
  addArrow(2,4, 1,7, ">", 20)()()("T^n(\overline{j})",     0.2, );
  addArrow(2,5, 1,7, ">", 20)()()("T^{n+1}(\overline{j})", 0.2, );
...
\noindent \TODO{The $T^n(\underline{t})$ morphisms DO NOT make sense!! 
They are collectively \quote{trunctation} morphisms. However they are a 
finite functor $T$ applied multiple times to the most truncated morphism 
of them all $\underline{t}$. We have lost too much information before we 
even being!} 
