...
Mathematics to be founded computationally. Hilbert's primary objective was 
to provide a rigorous foundation for Analysis whose metamathematics is 
finitist.

\TODO{With standard computation... need to define ordinals.... need axiom 
of choice to go beyond $\omega$.} 

We can persue this objective in two distinct ways. Most \quote{simply}, we 
can view Analysis to be about (measurement) \emph{processes}. If instead 
we allow ourselves to assume the existence of a computation variant of the 
Axiom of Choice, we can interpret Zermelo–Fraenkel set theory (with the 
Axiom of Choice) computationally. This allows us (assuming the Axiom of 
Choice) to found all of classical Analysis. In both cases, the 
meta$^*$-mathematics will be finitist. The difference between these two 
approaches will be in the slightly different (internal) logics associated 
with the two approaches. I conjecture that these different logics provide 
an explanation of the \quote{strangeness} of Quantum Mechanics. 
