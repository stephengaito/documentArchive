...
\subsection[title=First subsection]
\subsection[title=Second subsection]
\subsection[title=Third subsection]

\startChapterAppendices
\chapterAppendix[title=First chapter appendix]
...
\subChapterAppendix[title=A test subsection]
...
\subSubChapterAppendix[title=A test subsubsection]
...
\chapterAppendix[title=Second chapter appendix]
