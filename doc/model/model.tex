...
are no commercial implementations of this \joylol\ model of computation. 
In this chapter we define a model of an idealized \emph{commercial} CPU 
upon which we can rigorously implement pure \joylol. 
