...
unverified, \joylol\ interpreter. 

\item \bold{Step 2:} Use the \joylol\ interpreter to produce an 
interpreted jPeg parser. 

\item \bold{Step 3:} Use the interpreted jPeg parser to produce \joylol\ 
configuration file (JCF), and \joylolRM\ parsers. 

\item \bold{Step 4:} Use the JCF and \joylolRM\ parsers to produce a 
\emph{self-hosted} (unverified) \joylol\ compiler. 

\item \bold{Step 5:} Use the unverified \joylol\ compiler to produce a 
self-hosted, \emph{verified}, \joylol\ compiler. 

\item \bold{Step 6:} Use the verified \joylol\ compiler to produce a 
