...
\emph{logical} Program fail. In this analysis, one of the two the key 
...
amount of classical analysis even with $\omega$-computation resources. For 
a given amount of computational resources, we build a dual pair of 
